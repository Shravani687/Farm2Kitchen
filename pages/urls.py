...
from .views import  ask_ai_endpoint, dashboard_view, delete_product, delete_user, export_report,  home, orders,  smart_login_view, update_order_status_api # <--- Import login_api
...
from .views import farmer_inventory_api, toggle_product_status, admin_dashboard, admin_delete_user, ask_ai_assistant  # <--- Import admin_dashboard_view and admin_delete_user
urlpatterns = [
    path('', home, name='home'),
   ...
   path('api/admin/delete-user/<int:user_id>/', admin_delete_user, name='admin_delete_user'),
    ...
    path('ask-ai/', ask_ai_assistant, name='ask_ai'),
    path('ask-ai/', ask_ai_endpoint, name='ask_ai')
